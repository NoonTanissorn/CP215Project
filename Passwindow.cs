...
namespace CP215Project
{
    public class PassWindow : Actor
    {
        ...
        public PassWindow(Vector2 size, Color backgroundColor, Color outlineColor, float outlineWidth = 2)
        {
            ...
            currentPosition = new Vector2(50, 10); // Initial position for the first text
            ...
            var buttonclear = new Button("BlackOpsOne-Regular.ttf", 50, Color.Brown, "clear", new Vector2(250, 100));
        ...
        {
            var newText = new Text("BlackOpsOne-Regular.ttf", 200, Color.Green, textValue);
